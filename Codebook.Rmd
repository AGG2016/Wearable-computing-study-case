...
The 'Second Part' of the script summarizes the data, reporting the mean of each of the variables retained, for each activity of each of the participants in the experiments ('FinalReport.csv').
